...
class PostsController extends Controller
{
    ...
    public function fetch(Request $request){
        $wall_type = $request->input('wall_type'); // 0 => all posts, 1 => profile posts, 2 => group posts, 5 => browse all post
    ...
    public function create(Request $request){
        ...
        if ($request->hasFile('image')){
            $validator_data['image'] = 'required|mimes:jpeg,jpg,png,gif,jpeg|max:2048';
        }else{
